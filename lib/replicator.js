(function(module) {
     ...
     *
     * Any previous queue object must be cleaned up by the caller.
     *
     * @param {Queue} queue An instance of zk-redis-queue
     */
     ...
     * Process next item
     *
     * Runs only if the replicator has been started.
     *
     * Schedules itself again when done.
     */
    ...
    /**
     * Push a replication task to the queue.
     *
